...
Claude Code 是一个比较领先的 AI 编程智能体，要发挥最大的效果，需要搭载他们家自己的大模型，例如：Claude Opus 4.5，这个最强的编程模型，但是由于国内众所周知的原因，直接使用官方的套餐很麻烦，而且容易封号，就算是拼车也要花不少钱，而且不稳定，所以，我这边使用 Claude Code 都是使用的国产模型来替代，目前，市面上形成比较大共识的就是使用 GLM4.6 来做平替，效果肯定是和官方大模型有很大差距的，但是用来干一些简单的活还是很划算，最佳实践就是各种大模型组合起来使用，降低使用成本，GLM4.6 就是专门干那种粗活累活的，现在又可以搭配 Augment 的上下文引擎，效果要好很多，需要开通 GLM4.6 的，可以点击这里链接进去：[https://www.bigmodel.cn/claude-code?ic=LT6EWTAJTY](https://www.bigmodel.cn/claude-code?ic=LT6EWTAJTY)

搭配好了，使用效果如下：

![20251204090056](https://img.bokecity.com/ndedu/20251204090056.png)

## 官方文档

官方文档地址：[https://docs.augmentcode.com/context-services/mcp/quickstart-claude-code](https://docs.augmentcode.com/context-services/mcp/quickstart-claude-code)
